package in.healthhunt.view.termAndConditions;
...
public class TermsAndConditions extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(IHomeView != null) {
            IHomeView.updateTitle(getString(R.string.terms_and_conditions));
        }
    ...
    private void openTermsAndConditions() {
        WebSettings webSetting = mTermsWebView.getSettings();
        //webSetting.setBuiltInZoomControls(true);
        webSetting.setJavaScriptEnabled(true);

        mTermsWebView.setWebViewClient(new WebViewClient() {
            @Override
        ...
        mTermsWebView.loadUrl("file:///android_asset/terms_conditions.html");
    }
